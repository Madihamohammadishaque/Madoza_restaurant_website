<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">MADOZA</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="/res" class="hvr-grow">Home</a></li>
		        <li><a href="/res/about-madoza.php" class="hvr-grow">About Us</a></li>
		        <li><a href="food-categories.php" class="hvr-grow">Categories</a></li>
		        <li><a href="foods.php" class="hvr-grow">Foods</a></li>
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +01681. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/res">Home</a></li>
	        <li><a href="/res/about-madoza.php">About Us</a></li>
