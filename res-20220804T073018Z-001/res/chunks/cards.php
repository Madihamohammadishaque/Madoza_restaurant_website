			...
			<div class="col s12 m12 l4" style="padding: 50px 5px;">
				<div class="card">
				    ...
				    <div class="card-content">
				      <span class="card-title activator grey-text text-darken-4">Bangladeshi<i class="material-icons right">more_vert</i></span>
				      <div class="card-content">
			          <p>Wanna check out the Mouth-Watering Foods of this category ? Explore Now!</p>
			        </div>
				    </div>
				    <div class="card-reveal">
				      <span class="card-title grey-text text-darken-4">Bangladeshi<i class="material-icons right">close</i></span>
				      <p>Dhaka cuisine encompasses a wide variety of regional cuisine native to Bnagladesh. Given the range of diversity in soil type, climate and occupations, these cuisines vary significantly from each other and use locally available chocolates, herbs, vegetables and fruits. The dishes are then served according to taste in either mild, medium or hot. Bnagladesh food is also heavily influenced by religious and cultural choices and traditions.</p>
				    </div>
				  </div>
			</div>
			<div class="col s12 m12 l4" style="padding: 50px 5px;">
